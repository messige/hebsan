...
<td>Iudicábit in natiónibus, im<highlight2><accent>plé</accent></highlight2>bit ru<accent>í</accent>nas <greStar /><br class="psalm" />conquassábit cápita in  <highlight1><accent>ter</accent></highlight1>ra mul<accent>tó</accent>rum.</td></tr>

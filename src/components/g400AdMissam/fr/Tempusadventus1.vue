...
aucun ne sera confondu.</ion-text></ion-col> </ion-row></ion-grid>Ps. Vias tuas, Domine, demonstra mihi :<br />
...
et terra nostra dabit fructum suum.<ion-grid> <ion-row><ion-col>&nbsp;</ion-col><ion-col size="11"><ion-text color="tertiary">Le Seigneur donnera sa bienveillance :<br />

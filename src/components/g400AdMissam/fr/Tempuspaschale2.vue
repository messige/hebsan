...
Celui que vous cherchez est réssuscité comme il l'a dit.</ion-text></ion-col> </ion-row></ion-grid>V./  Euntes dicite discipulis eius:<br />
ecce praecedet vos in Galilaeam:<br />
ibi eum videbitis, sicut dixit.<ion-grid> <ion-row><ion-col>&nbsp;</ion-col><ion-col size="11"><ion-text color="tertiary">Allez, dites à ses disciples :<br />
voici qu’il vous précédera en Galilée :<br />
c’est là que vous le verrez, comme il l’a dit.</ion-text></ion-col> </ion-row></ion-grid>V./  Iesus stetit in medio eorum et dixit:<br />
Pax vobis!<br />
Videte, quia ego ipse sum.<ion-grid> <ion-row><ion-col>&nbsp;</ion-col><ion-col size="11"><ion-text color="tertiary">Jésus parut debout au milieu d'eux et dit :<br />
La paix soit avec vous. Voyez,<br />
c'est bien moi.</ion-text></ion-col> </ion-row></ion-grid>	

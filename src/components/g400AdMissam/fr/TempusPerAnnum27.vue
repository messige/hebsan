...
<ion-text color="tertiary">En votre volonté, Seigneur, toutes choses sont placées,<br />
...
le Seigneur de toutes choses, c’est vous.</ion-text></ion-col></ion-row></ion-grid>
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Il y avait sur terre un homme, appelé Job :<br />
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Mon âme dépend de votre salut :<br />

...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11"><ion-text color="tertiary">c'est ainsi qu'il reviendra.</ion-text></ion-col></ion-row></ion-grid>
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Le Seigneur est venu au Sinaï, au lieu saint,<br />
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Tout pouvoir m'a été donné au ciel et sur la terre, alléluia.<br />
...
et bene habebunt.
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Voici les miracles qui accompagneront<br />
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Psalmodiez pour le Seigneur,<br />
qui est monté au-dessus des cieux des cieux, à l’Orient !</ion-text></ion-col></ion-row></ion-grid>

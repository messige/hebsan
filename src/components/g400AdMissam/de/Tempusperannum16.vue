...
<ion-text color="tertiary">Seht, Gott hilft mir,<br />
...
Herr, mein Beschützer.</ion-text></ion-col></ion-row></ion-grid>
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Entreiß mich meinen Feinden, mein Gott!<br />
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Entgegen nehmen wirst du das Opfer der Gerechtigkeit,<br />
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Maria hat den besten Teil für sich erwählt;<br />
der soll nicht von ihr genommen werden in Ewigkeit!</ion-text></ion-col></ion-row></ion-grid>

...
<ion-text color="tertiary">Du, unser Beschützer, Gott,<br />
sieh doch; blicke auf das Angesicht deines Gesalbten!<br />
Denn ein Tag in deinen Vorhöfen ist besser<br />
als tausend andere.</ion-text></ion-col></ion-row></ion-grid>

 <!-- textType = P keyText = 7519 -->Ps. Quam dilecta tabernacula tua,<br />
Domine, virtutum!<br />
concupiscit et deficit anima mea in atria Domini.
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11"><ion-text color="tertiary">Wie liebenswert sind deine Wohnungen,<br />
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Gut ist es, zu vertrauen auf den Herrn,<br />
(besser) als zu vertrauen auf den Menschen.</ion-text></ion-col></ion-row></ion-grid>
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Der Engel des Herrn umschirmt alle,<br />
...
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Mein Haus soll ein Haus des Gebetes genannt werden,<br>spricht der Herr.<br />
...
dicit Dominus.
<ion-grid><ion-row><ion-col>&nbsp;</ion-col><ion-col size="11">
<ion-text color="tertiary">Sucht zuerst das Reich Gottes,<br />

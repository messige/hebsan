import moment from 'moment';            // from https://github.com/rmehlinger/adventjs#readme
import 'moment-range';
...
export function adventSunday(year: number){
...
export function holySaturday(year: number){
...
export function holyThursday(year: number){
    return easter(year).subtract(3, 'days');
}

export function palmSunday(year: number){
    return easter(year).subtract(7, 'days');
}

export function ashWednesday(year: number) {
    return easter(year).subtract(46, 'days');
}

export function ascension(year: number) {
    return easter(year).add(39, 'days');
}

export function pentecost(year: number) {
...
export function advent(year: number){
    return moment.range(
...
export function firstChristmasSeason(year: number){
    return moment().range(
        new Date(year, 0, 1),
...
export function secondChristmasSeason(year: number){
    return moment().range(
        christmas(year),
        new Date(year + 1, 0, 1)
    )
...
export function firstOrdinaryTime(year: number) {
    return moment().range(baptismOfTheLord(year: number).dayAfter(), ashWednesday(year));
}

export function lent(year: number){
    return moment().range(ashWednesday(year), holyThursday(year));
}

export function holyWeek(year: number){
    return moment().range(palmSunday(year), easter(year).dayAfter());
}

export function triduum(year: number){
    return moment().range(holyThursday(year), easter(year));
}

export function easterSeason(year: number){

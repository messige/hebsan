  ...
  <ion-page>
    ...
    <ion-content id="container">
      ...
      <h2>
        ...
        <br class="smallScreen" />&nbsp;-&nbsp;{{ typeOffice.title }}
      </h2>
      <br />
        ...
        <ion-grid
          ><ion-row>
            ...
            <ion-col size="11"
              ><ion-text color="tertiary">
                <component
                  :is="officeCurrent.antiphonaTR"
                /> </ion-text></ion-col></ion-row
        ></ion-grid>
      </template>
      <p>
        <component :is="officeCurrent.psalm1" />
        <component :is="officeCurrent.psalm2" />
        <!-- for the Triduum  -->
      </p>
      <template v-if="officeTempusLiturgicus1.tempus != 'triduum'">
        <component :is="officeCurrent.antiphona" />
  ...
  setup() {
        ...
        arrayFeastOffices: [
          {
            ...
            antiphonaTR: defineAsyncComponent(
              () =>
                import(
                  "../components/g50Antiphona/" + lowerLang + "/AntPueriVestimenta2.vue"
                )
            ),
        ...
        arrayFeastOffices: [
          ...
          },
          {
            ...
            antiphonaTR: defineAsyncComponent(
              () =>
                import(
                  "../components/g50Antiphona/" + lowerLang + "/AntLabiaInsurgentibus.vue"
                )
            ),
            psalm1: defineAsyncComponent(
        ...
        arrayFeastOffices: [
          {
            ...
            antiphonaTR: defineAsyncComponent(
              () =>
                import(
                  "../components/g50Antiphona/" + lowerLang + "/AntAnteDiemPaschae.vue"
                )
            ),
            psalm1: defineAsyncComponent(
              () => import("../components/g65Psalmodia/" + lowerLang + "/Ps118D13-16.vue")
          ...
          },
          {
            ...
            antiphonaTR: defineAsyncComponent(
              () =>
                import(
                  "../components/g50Antiphona/" + lowerLang + "/AntPotestatemHabeo2.vue"
                )
            ),
            psalm1: defineAsyncComponent(
              () => import("../components/g65Psalmodia/" + lowerLang + "/Ps118D17-19.vue")
        ...
        arrayFeastOffices: [
          {
            ...
            antiphonaTR: defineAsyncComponent(
              () =>
                import(
                  "../components/g50Antiphona/" + lowerLang + "/AntIpsiVeroInVanum2.vue"
                )
            ),
            psalm1: defineAsyncComponent(
              () => import("../components/g65Psalmodia/" + lowerLang + "/Ps118D13-16.vue")
    ...
    const arrayCapitulum = [
      ...
      },
      {
        ...
        capitulumTR: defineAsyncComponent(
          () => import("../components/g75Lectio/" + lowerLang + "/XFactusEstFeria7.vue")
        ),
      },
    ]; // Feria VII
    i = 0;
    ...
    const arrayOratio = [
      ...
      },
      {
        ...
        oratioTR: defineAsyncComponent(
          () =>
            import(
              "../components/g80Oratio/" + lowerLang + "/OraSuperHancFamiliamTriduo.vue"
            )
        ),
      },
    ];

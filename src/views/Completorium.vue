...
<script lang="ts"> 
    ...
    export default defineComponent ( {
        name: 'Completorium',
        components: {   Confitebor , Capitulum , NuncDimittisSineGloria , Oratio , DominusVobiscum ,
                        PerDominum , ImageDisplay , IonPage , IonContent , IonHeader , IonFooter , 
        ...
        setup ( ) {
            ...
            return  { feast , feastNum , feastCurrent , officeTempusLiturgicus1 , officeTempusLiturgicus2 , 

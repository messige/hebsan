  ...
  <ion-content id="container">
    <ion-header class="ion-no-border">
      <ion-toolbar>
        ...
        <ion-title>{{feastCurrent.title}} - {{feastCurrent.titleFr}}
            <br class="psalm" />&nbsp;-&nbsp;Ad Competorium</ion-title>  
      </ion-toolbar> 
      <br />
    </ion-header>  
    <template v-if="officeTempusLiturgicus1.tempus != 'triduum'">
        ...
        <ion-grid><ion-row>
            ...
            <ion-col size="11"><ion-text color="tertiary">
                <component   :is = "officeTempusLiturgicus1.iubeTR"/>
            </ion-text></ion-col>
        </ion-row></ion-grid> 
       <component    :is="officeTempusLiturgicus1.fratres"/>
        <ion-grid><ion-row>
            <ion-col>&nbsp;</ion-col>
            <ion-col size="11"><ion-text color="tertiary">
                <component   :is = "officeTempusLiturgicus1.fratresTR"/>
            </ion-text></ion-col>
        </ion-row></ion-grid> 
        ...
        <ion-grid><ion-row>
            <ion-col>&nbsp;</ion-col>
            <ion-col size="11"><ion-text color="tertiary">
                <component   :is = "arrayOrdine[1].ordineTR"/>
            </ion-text></ion-col>
        </ion-row></ion-grid> 
    </template>
    <component    :is="arrayOrdine[0].ordine"/>
        <ion-grid><ion-row>
            <ion-col>&nbsp;</ion-col>
            <ion-col size="11"><ion-text color="tertiary">
                <component   :is = "arrayOrdine[0].ordineTR"/>
            </ion-text></ion-col>
        </ion-row></ion-grid> 
    <component    :is="arrayOrdine[2].ordine"/>
        <ion-grid><ion-row>
            <ion-col>&nbsp;</ion-col>
            <ion-col size="11"><ion-text color="tertiary">
                <component   :is = "arrayOrdine[2].ordineTR"/>
            </ion-text></ion-col>
        </ion-row></ion-grid> 
    <template v-if="officeTempusLiturgicus1.tempus != 'triduum'">
      ...
      <component    :is = "officeTempusLiturgicus2.ant" />
        <ion-grid><ion-row>
            <ion-col>&nbsp;</ion-col>
            <ion-col size="11"><ion-text color="tertiary">
                <component   :is = "officeTempusLiturgicus2.antTR"/>
            </ion-text></ion-col>
        </ion-row></ion-grid> 
    </template>
    ...
    <template v-if="officeTempusLiturgicus1.tempus != 'triduum'">
        ...
        <ion-grid><ion-row>
            <ion-col>&nbsp;</ion-col>
            <ion-col size="11"><ion-text color="tertiary">
                <component   :is = "objTranslations.capitulum"/>
            </ion-text></ion-col>
        </ion-row></ion-grid> 
        ...
        <ion-grid><ion-row>
            <ion-col>&nbsp;</ion-col>
            <ion-col size="11"><ion-text color="tertiary">
                <component   :is = "officeTempusLiturgicus1.responsumTR"/>
            </ion-text></ion-col>
        </ion-row></ion-grid>           
    ...
    <template v-if="officeTempusLiturgicus1.tempus != 'triduum'">
        ...
        <ion-grid><ion-row>
            <ion-col>&nbsp;</ion-col>
            <ion-col size="11"><ion-text color="tertiary">
                <component   :is = "objTranslations.oratio"/>
            </ion-text></ion-col>
        </ion-row></ion-grid>     
        <p><DominusVobiscum /></p>        
    </template> 
    ...
    <component :is="officeTempusLiturgicus2.AntMaria"/>
        <ion-grid><ion-row>
            <ion-col>&nbsp;</ion-col>
            <ion-col size="11"><ion-text color="tertiary">
                <component   :is = "officeTempusLiturgicus2.AntMariaTR"/>
            </ion-text></ion-col>
        </ion-row></ion-grid>
    <br />        
...
<script lang="ts"> 
    ...
    export default defineComponent ( {
        name: 'Completorium',
        components: { Capitulum , NuncDimittisSineGloria , Oratio , DominusVobiscum , PerDominum , Pater , Kyrie ,
                        IonPage , IonContent  , IonHeader , IonFooter , IonToolbar , IonTitle , IonButton , IonIcon } ,
        setup ( ) {
            ...
            const arrayOrdine  = [
                ...
                { ordine: defineAsyncComponent(() =>                            
                  ...
                  ordineTR:   defineAsyncComponent(() => 
                    import ( '../components/g95InOrdineOfficii/' + lowerLang  + '/AdiutoriumNostrum.vue' ) ) } ,
                { ordine: defineAsyncComponent(() =>                            
            ...
            {   tempus:         "quadragesimae" ,
                ...
                AntMariaTR:     defineAsyncComponent( () =>                            
                                    import ( '../components/g50Antiphona/' + lowerLang  + '/AntAveReginaCaelorum.vue' ) ) } ,
            {   tempus:         "paschali" ,
                inAdiutoriumFin: defineAsyncComponent(() =>                            
            ...
            return  {   i , feast , feastNum , feastCurrent , officeTempusLiturgicus1 , officeTempusLiturgicus2 , 
                        officeLectio , home , arrowBackSharp , objTranslations , arrayOrdine }
        }
    } )
</script>